...
2. **Given** a user navigates to the About page, **When** the hero image loads, **Then** the image should be properly sized and not stretched or distorted.
...
- What happens if the "Our Story BG.jpg" image fails to load? The system should fall back to a solid dark background color.
...
- **SC-004**: Hero text readability is improved with 50% overlay contrast on the home page.
