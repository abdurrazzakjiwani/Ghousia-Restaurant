...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 left-6 z-40 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow"
